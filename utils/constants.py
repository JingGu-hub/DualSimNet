...
UCR128_DATASET = ['ElectricDevices']
                                ...
                                #'ArticularyWordRecognition', 'CharacterTrajectories'', 'FingerMovements', 'Heartbeat', 'JapaneseVowels',
                                # 'PhonemeSpectra', 'SpokenArabicDigits', 'NATOPS', 'SelfRegulationSCP1', 'SelfRegulationSCP2'
# Multivariate2018_arff_DATASET = ['ArticularyWordRecognition']
Multivariate2018_arff_DATASET = ['Heartbeat']
...
Four_dataset = ['HAR', 'AUSLAN'] # 'HAR', 'AUSLAN'
# Four_dataset = ['ArabicDigits', 'ECG5000', 'RacketSports', 'AUSLAN', 'FaceAll', 'StarLightCurves', 'NetFlow', 'ISRUC', 'UniMiB-SHAR', 'HAR', 'Sleep-EDF', 'Epilepsy', 'FD', 'UWare', 'Wafer']
